		...
		methods: {
			...
			removeProduct(productNumber) {
				this.addedProducts.totalCost =
					this.addedProducts.totalCost - this.addedProducts.products[productNumber].price
			...
			updateSelected(val, type, productNumber) {
				...
				if (isChecked) {
					if (val.length < 4) this.addedProducts.products[productNumber].price = fixedPrice
					else this.addedProducts.products[productNumber].price++
				} else {
					if (val.length > 3) this.addedProducts.products[productNumber].price--
					else if (val.length && val.length < 4) this.addedProducts.products[productNumber].price = fixedPrice
