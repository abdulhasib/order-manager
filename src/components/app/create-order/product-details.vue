<template>
  ...
  >
    ...
    <div
      class="product-details-form-section-container"
    >
      <v-row>
        <v-col
          cols="12"
...
<script>
  export default {
    ...
    data () {
      return {
        addedProducts: [],
        standardProductsList: [{ label: 'Standard 1' }, { label: 'Standard 2' }, { label: 'Standard 3' }, { label: 'Standard 4' }],
        premiumProductsList: [{ label: 'Premium 1' }, { label: 'Premium 2' }, { label: 'Premium 3' }, { label: 'Premium 4' }]
      }
    },
    computed: {
    },
